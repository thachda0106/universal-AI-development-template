...
boundaries:
  ...
  - Do NOT design backend APIs or server-side architecture
...
- **Search**: Analyze component structure, locate UI patterns, search for design tokens
- **Read**: Understand existing components, review accessibility reports, read design specs
- **Edit**: Create and modify UI components, styles, and accessibility features
- **Execute**: Run builds, lint, and accessibility audits
