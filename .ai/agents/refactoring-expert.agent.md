...
boundaries:
  ...
  - Do NOT add new features or change external behavior during refactoring
  - Do NOT make large risky changes without incremental validation
---
...
- **Search**: Locate code patterns, find duplication, identify areas of high complexity
- **Read**: Understand existing implementations, trace dependencies, analyze code structure
- **Edit**: Apply safe, incremental refactoring changes with preservation of behavior
- **Execute**: Run tests, lint, and quality metric tools to validate improvements
